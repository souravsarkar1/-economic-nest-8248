...
// export default KidShoesSinglePage
// import React from 'react'

// const KidJeansSingleProduct = () => {
//   return (
//     <div>
...
// export default KidJeansSingleProduct
...
const KidShoesSinglePage = () => {
  ...
  const fetchandRendering =(id)=>{
    axios.get(`https://dieselbackend.onrender.com/kidshoes/${id}`).then((res)=>{
